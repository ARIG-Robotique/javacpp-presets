JavaCPP Presets for RPLIDAR SDK
===============================
 ...
 * rplidar sdk 1.5.6  https://github.com/ofTheo/videoInput
...
Sample Usage
------------
Here is a simple example of RPLIDAR SDK ported to Java from the "Example Usage" in this C++ source file:
